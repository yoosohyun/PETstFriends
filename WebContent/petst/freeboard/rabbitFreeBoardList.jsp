				...
				<c:forEach items="${selectBoardLike }"  var="freeBoard">
					<div class="portfolio-item" align="center"
						...
						<div style=" height: 200px;">
								...
								<div style="width=200px; border: 1px solid black;" align="center">
...
<!-- 								</h5> -->
<!-- 							</div> -->
						<div class="col-md-8" style="text-align: center; height: 30px;">
								<h5>
									<font
										style="font-family: 'NanumSquareRound', sans-serif; font-size:15px; color: black;">
									<center>	${freeBoard.freeBoard_title}</center></font>
								</h5>
							</div>
						</div>
<!-- 						마우스올리면 오버레이~~ -->
						<div class="img-overlay" style="width: 250px; height: 300px; border: 1px solid white;">
	...
	<div style="border-bottom: 2px solid brown; width: 22%;">
               <div style="border-bottom: 5px solid #FFD232; width: 70%;">
             <div style="border:1px solid white ;  height: 50px; ">
               <h2 align="left"> <font style="font-size: 20px;"><b>토끼광장</b></font> </h2>
               </div>
               </div>
               </div>
               <br>
				...
				<div class="numbers" align="center" style="width: 850px;">
						...
						<ul class="pagination">
								...
								<c:if test="${start != 1 }">
									...
									<li><a href="rabbitFreeBoardList.do?page=1&type=${type }&keyword=${keyword }&startDate=${startDate}&endDate=${endDate}">[처음]</a></li>
									<li><a href="rabbitFreeBoardList.do?page=${start-1 }&type=${type }&keyword=${keyword }&startDate=${startDate}&endDate=${endDate}">[이전]</a></li>
								</c:if>
						...
						<c:choose>
							...
							<c:otherwise>
								<li><a
									href="rabbitFreeBoardList.do?page=${i }&type=${type }&keyword=${keyword }&startDate=${startDate}&endDate=${endDate}">[${i }]</a></li>
							</c:otherwise>
