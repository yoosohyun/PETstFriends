	...
	$(document).ready(function() {
		...
		var comment_start = ${comment_start}
			...
			var cPaging = function(){
				$.ajax({
					...
					success : function(data) {
						var session = '${sessionScope.adminCheck}';
						...
						for(var i in fList){
							if(fList[i].freeComments_commentno == fList[i].freeComments_parent){
								...
								commentStr +='<div class="dropdown"><div class="dropdown">닉네임'
							...
							if(session==1)
								commentStr +='<a class="openMask" id="'+fList[i].freeComments_userId+'">쪽지보내기</a>';
			...
			$(document).on('click', '.reComBtn', function(){
				...
				var tableStr = '';
				tableStr +='<tr><td colspan="3"><div>'
						+'<i class="fa fa-level-up fa-rotate-90"></i> @'+freeComments_nickname
						+ '</p><p align="left"><textarea id="rereply_content" rows="3" cols="110" name="rereply_content"></textarea>'
...
// 						alert(comment_finalpage+"fianl")
			...
			$(document).on('click', '.modifyComBtn', function(){
				...
				tr.empty();
				var tableStr ='';
				tableStr +='<td colspan="3"><div><textarea class="modi_content" style="text-align=left;" rows="3" cols="112" name="modi_content">'
...
<div class="container"style="border: 1px solid white; width:900px;">
		...
		<div style="border-bottom: 2px solid brown; width: 22%;">
             ...
             <div style="border:1px solid white ;  height: 50px; ">
               <h2 align="left"> <font style="font-size: 20px;"><b>펫프광장</b></font> </h2>
               </div>
               </div>
               </div>
			...
			<table class="table">
				<tr align="center" style="font-family: 'monaco';" bgcolor="white">
					...
					<td style="width: 150px">조회수 : ${freeBoard.freeBoard_readCount }</td>
				</tr>
				<tr>
				<td colspan="7">
				<div class="dropdown">
							<a class="dropbtn"><font style="font-size: 16px;">작성자 : ${freeBoard.freeBoard_userId }</font></a>
				...
				<tr>
					...
					<td align="left" colspan="5" height="200" width="700"  style="border-top: 1px solid white; text-align: left: ;">
					<br><br><br><br>
...
<!-- 					<input -->
<!-- sessionScope.adminCheck !=null -->
<!-- 						type="button" value="뒤로" onclick="history.back();" /> -->
						  <input type="button" value="목록"
						onclick="location.href='dogFreeBoardList.do'">  <c:if
							test="${freeBoard.freeBoard_userId eq user_idCheck || sessionScope.adminCheck !=null}">
				...
				<table id="commentTable" style="border: none;">
					<c:forEach items="${commentList }" var="comment">
						<tr style="border-bottom: none;">
							...
							<td class="btnTD">${comment.freeComments_writeDate }</td>
						</tr>
						...
						<tr>
							...
							<td class="btnTD"><c:if test="${user_idCheck != null }">
									...
									test="${(comment.freeComments_content !=null &&
											comment.freeComments_userId eq user_idCheck) || sessionScope.adminCheck != null}">
