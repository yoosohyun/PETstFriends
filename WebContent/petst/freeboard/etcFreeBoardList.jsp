			...
			<div style="width: 30px; height: 100px; border: 1px solid white;">
				...
				<div class="portfolio-item" align="right"
						...
						<div style=" height: 200px;">
							...
							<div style="width: 250px; height: 250px; border: 1px solid red;">
...
<!-- 								</h5> -->
<!-- 							</div> -->
						<div class="col-md-8" style="text-align: left; height: 30px;">
								<h5>
									<font
...
<!-- 						마우스올리면 오버레이~~ -->
			<div class="img-overlay" style="width: 250px; height: 300px; border: 1px solid red;">
...
<!-- 		게시글 3개 -->
		<div style="border-bottom: 2px solid brown; width: 22%;">
               <div style="border-bottom: 5px solid #FFD232; width: 70%;">
             <div style="border:1px solid white ;  height: 50px; ">
               <h2 align="left"> <font style="font-size: 20px;"><b> 기타광장</b></font> </h2>
               </div>
               </div>
               </div>
<!-- 				<article>  -->
...
<!-- 					페이징처리 -->
					<ul class="pagination">
								...
								<c:if test="${start != 1 }">
									...
									<li><a href="etcFreeBoardList.do?page=1&type=${type }&keyword=${keyword }&startDate=${startDate}&endDate=${endDate}">[처음]</a></li>
									<li><a href="etcFreeBoardList.do?page=${start-1 }&type=${type }&keyword=${keyword }&startDate=${startDate}&endDate=${endDate}">[이전]</a></li>
								</c:if>
						...
						<c:choose>
							...
							<c:otherwise>
								<li><a
									href="etcFreeBoardList.do?page=${i }&type=${type }&keyword=${keyword }&startDate=${startDate}&endDate=${endDate}">[${i }]</a></li>
							</c:otherwise>
