...
<form action= "${path }" name="form" method="post">
 <table width="1400" height="650">
  ...
  <tr>
   ...
   <p align="left">
   <br>
   <span style="padding-left: 160px; align-items: center;"  >
<!--    <h4><b> -->
<!--    PETstFriends 약관동의</b></h4> -->

   <font style="font-family: 'NanumSquareRound', sans-serif; font-weight: bold;font-size: 30px; ">
			PETstFriends 약관동의
			</font>
...
- 생성정보 수집 툴을 통한 수집
  ...
  <tr>
   <td align="center" valign="top">
    <input type="button" value="동의" onclick="chk()" class="btn btn-warning btn-sm"> &nbsp;&nbsp;&nbsp;
    <input type="button" value="동의하지 않습니다" onclick="nochk()" class="btn btn-warning btn-sm">
   </td>
  </tr>
 </table>
</form>
