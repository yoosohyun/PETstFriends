...
<div class="container1" style="display: inline-block; width:80%; height:550px;">
	    <div class="bs-example" style=" border: 1px solid #bcbcbc; height: 450px; ">
	<ul class="nav nav-tabs navbar-" >
        <li  style="width: 50%"><a href="FindUserIdForm.do">아이디 찾기</a></li>
        <li style="width: 50%; background-color: #EBC680;"><a href="FindUserPwForm.do"><b>비밀번호 찾기</b></a></li>
	</ul>
		...
		<table>
			...
			<tr>
				<td colspan="4" align="center">
					...
					<button id=findPwBtn
						style="width: 80px; height: 28px;  border: 1 solid white">확인</button><br>
				</td>
			</tr>
		</table>
		</div>
