...
<div class="wrapper">
		 <div class="container"style="border: 1px solid white; width:900px;">
			...
			<h2 align="left"  style="font-family: 'NanumSquareRound', sans-serif; font-size: 20px; font-weight:bold;">
			강아지 종 정보 
			</h2>
					</div></div></div></div><br>
...
<!-- 							</h1> -->
								<img src="./Boot/images/nothumnails.jpg"
									alt="ocean" width="210px" height="210px">
						</c:if>
...
<!-- 								</h5> -->
						...
						<div class="col-md-11" style="text-align: center; height: 30px;">
								<h5>
									<font
										style="font-family: 'NanumSquareRound', sans-serif; font-weight: bold; color: #8B5927;">
										${e.encyc_title}</font>
...
<!-- 								</h5> -->
						...
						<div class="col-md-11" style="text-align: center; height: 40px;">
								<h5>
									<font
										style="font-family: 'NanumSquareRound', sans-serif; font-weight: bold; color: color: #8B5927;">
										${e.encyc_title}</font>
								</h5>
							</div>
						</div>
