...
<body>
	...
	<div class="wrapper">
	<div class="container" style="border: 1px solid red; width:900px;">
		...
		<div class="main-content">
			<div class="container1" style="background: white;">
               ...
               <h2 align="left"><font style="font-family: 'NanumSquareRound', sans-serif ;font-size:20px;"> <b>쪽지함 Admin</b> </font></h2>
					</div>
					</div>
					</div> 
				...
				<table class="table" style="width: 870px;" >
					<thead>
						<tr>
							<th></th>
							<th width="100px;"style="text-align: center">쪽지 번호</th>
							<th width="100px;"style="text-align: ">쪽지 제목</th>
							<th width="100px;"style="text-align: center">받는 사람 ID</th>
							<th width="100px;"style="text-align: center">보낸 날짜</th>
						</tr>
					</thead>
					<tbody id="msgtable" style="text-align: center;">
					</tbody>
				</table>
		...
		<input type="text" id="searchbox" style="width: 200px; height: 27px;">
		<input type="button" value="검색" id="search" style="height: 27px;">
		</div>
